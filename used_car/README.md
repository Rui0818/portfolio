...
Over the past year, as the pandemic disrupted supply chains and caused shortages in
critical auto components, resulting in a lack of new vehicles, which caused the used car price
surging.
...
car is a good deal. So, our team tried to create a method to determine whether the price of a used
car is appropriate.